...
# RobustScaler: data transformation - normalization
...
Apply both robust scaler and standard scaler
	...
	|fit RobustScaler quantity into RS1 as RS_t with with_centering=true with_scaling=true
	|fit RobustScaler quantity into RS2 as RS_f with with_centering=false with_scaling=false
	|fit StandardScaler quantity into SS1 as SS_t with_mean=true with_std=true
	|fit StandardScaler quantity into SS2 as SS_f with_mean=f with_std=f
	|fieldsummary RS_t_quantity RS_f_quantity SS_t_quantity SS_f_quantity, quantity
